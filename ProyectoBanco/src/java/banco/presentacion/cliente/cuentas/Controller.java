 ...
 * @author ESCINF
 */
@WebServlet(name = "controllerCuentasShow", urlPatterns = {"/presentation/cliente/datos/show", "/presentation/login/transferencia", "/presentation/login/infoPersonal", "/presentation/cliente/cuentasFav", "/cliente/cuentas/favoritas", "/cuentas/favoritas/eliminar"})
